        ...
        <section class="page-block">
            <div class="container d-flex flex-column flex-lg-row align-items-center justify-content-between">
                <div class="me-0 col-12 pe-lg-4 col-lg-7">
                    ...
                    <p class="p-title">Этот проект представляет собой уникальное сочетание комфорта и современного дизайна для городской жизни.</p>
                </div>
                <div class="col-12 col-lg-5 col-xxl-4">
                    <div class="project-parameters-container text-lg-start text-center row">
                        ...
                        <div class="project-parametr mt-4 mt-lg-0 col-12 col-sm-6">
                            ...
                            <p>ул. Новый Арбат вл. 2, Москва, Россия</p>
                        </div>
                        <div class="project-parametr mt-4 mt-lg-0 col-12 col-sm-6">
                            <h6 class="h6">Общая поэтажная площадь</h6>
                            <p>13 320 / 20 231 / 15 000 м²</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="img-container col-12 col-xxl-7 mx-end">
                        <img src="img/project-hero-temp.jpg" class="project-page-block-img">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="">
                    ...
                    <div class="project-gallery-container row">
                        <div class="img-container mx-auto col-12 col-sm-7 col-lg-4">
                            <img src="img/project-hero-temp.jpg" class="gallery-image img-fluid" alt="gallery-img">
                        </div>
