...
<head>
    ...
    <title>Промышленные объекты</title>
    <meta name="description" content="Проекты промышленных объектов от архитектурного бюро Инспат - логистические комплексы, лаборатории, заводы и производственные помещения.">
    <meta name="keywords" content="Инспат, промышленные объекты, логистические комплексы, лаборатории, заводы, производственные помещения, архитектурное бюро">
...
<header class="fixed-top fixed-header-wrap">
    ...
    <section class="page-block">
            <div class="container">
                <div class="row">
                    <h2 class="h2 mb-5">Промышленные объекты</h2>
                    <a href="industrial-building-projects/project-industrial-1.html" class="col-lg-4 col-sm-6 mb-4 col-12">
                    ...
                    <a href="industrial-building-projects/project-industrial-2.html" class="col-lg-4 col-sm-6 mb-4 col-12">
                        <div class="project-card-preview">
                            <div class="img-container">
                    ...
                    <a href="industrial-building-projects/project-industrial-3.html" class="col-lg-4 col-sm-6 mb-4 col-12">
                        <div class="project-card-preview">
                            <div class="img-container">
                    ...
                    <a href="industrial-building-projects/project-industrial-4.html" class="col-lg-4 col-sm-6 mb-4 col-12">
                        <div class="project-card-preview">
                            <div class="img-container">
                    ...
                    <a href="industrial-building-projects/project-industrial-5.html" class="col-lg-4 col-sm-6 mb-4 col-12">
                        <div class="project-card-preview">
                            <div class="img-container">
