...
<head>
    ...
    <title>Жилые здания</title>
    <meta name="description" content="Проекты жилых зданий от архитектурного бюро Инспат - жилые комплексы, многоквартирные дома и другие объекты жилой недвижимости.">
    <meta name="keywords" content="Инспат, жилые здания, жилые комплексы, многоквартирные дома, жилая недвижимость, архитектурное бюро">
...
<header class="fixed-top fixed-header-wrap">
    ...
    <section class="page-block">
            <div class="container">
                <div class="row">
                    <h2 class="h2 mb-5">Жилые здания</h2>
                    <a href="living-building-projects/project-living-1.html" class="col-lg-4 col-sm-6 mb-4 col-12">
                    ...
                    <a href="living-building-projects/project-living-2.html" class="col-lg-4 col-sm-6 mb-4 col-12">
                        <div class="project-card-preview">
                            <div class="img-container">
                    ...
                    <a href="living-building-projects/project-living-3.html" class="col-lg-4 col-sm-6 mb-4 col-12">
                        <div class="project-card-preview">
                            <div class="img-container">
                    ...
                    <a href="living-building-projects/project-living-4.html" class="col-lg-4 col-sm-6 mb-4 col-12">
                        <div class="project-card-preview">
                            <div class="img-container">
                    ...
                    <a href="living-building-projects/project-living-5.html" class="col-lg-4 col-sm-6 mb-4 col-12">
                        <div class="project-card-preview">
                            <div class="img-container">
                    ...
                    <a href="living-building-projects/project-living-6.html" class="col-lg-4 col-sm-6 mb-4 col-12">
                        <div class="project-card-preview">
                            <div class="img-container">
                    ...
                    <a href="living-building-projects/project-living-7.html" class="col-lg-4 col-sm-6 mb-4 col-12">
                        <div class="project-card-preview">
                            <div class="img-container">
