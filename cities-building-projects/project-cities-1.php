...
<head>
    ...
    <title>Жилой комплекс "Нагатино"</title>
    <meta name="description" content="Жилой комплекс «Нагатино» - проект с 4 жилыми корпусами и встроенно-пристроенной автостоянкой. Разработка проектной документации СПОЗУ, ПОС, ПОД, ВПВ, АПТ, ООС и рабочей документации ОВ.">
    <meta name="keywords" content="Инспат, жилой комплекс Нагатино, проектирование, СПОЗУ, ПОС, ПОД, ВПВ, АПТ, ООС, рабочая документация, ЮАО, Москва">
        ...
        <section class="page-block">
            <div class="container d-flex flex-column flex-lg-row align-items-center justify-content-between">
                <div class="me-0 col-12 pe-lg-4 col-lg-7">
                    <h2 class="h2">ЖИЛОЙ КОМПЛЕКС «НАГАТИНО»</h2>
                    <p class="p-title">Разработка Проектной документации разделов СПОЗУ, ПОС, ПОД, ВПВ. АПТ, ООС. Прохождение экспертизы. Разработка Рабочей документации раздела ОВ.</p>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="me-0 col-12 col-xxl-5 pe-lg-4">
                        ...
                        <p class="p-title">Решение комплекса выполнено с размещением 4-х жилых корпусов и 
                            встроенно-пристроенной автостоянки с единой стилобатной частью. 
                            На кровле стилобатного этажа размещена пешеходная зона, 
                            соединяющая вторые этажи корпусов и дающая возможность 
                            организовать двор «без машин» с досуговыми площадками, 
