...
<head>
    ...
    <meta name="description" content="Правовая информация архитектурного бюро Инспат - условия использования сайта и юридические аспекты сотрудничества.">
    <meta name="keywords" content="Инспат, правовая информация, юридические аспекты, условия использования, архитектурное бюро">
...
<body>
    ...
    <main>
        ...
        <section class="page-block">
            <div class="container">
                <div class="row mb-4">
                    <div class="me-0 col-12">
                        <h2 class="h2">Правовая информация</h2>
                        <p class="p-title">Раздел в разработке</p>

                        <!-- <p class="p-title">
                            <a href="legal-files/legal-pdf-test.pdf" target="_blank">Первый правовой файл</a>
                        </p>
                        <p class="p-title">
                            <a href="legal-files/legal-pdf-test.pdf" target="_blank">Второй правовой файл</a>
                        </p>
                        <p class="p-title">
                            <a href="legal-files/legal-pdf-test.pdf" target="_blank">Третий правовой файл</a>
                        </p> -->
